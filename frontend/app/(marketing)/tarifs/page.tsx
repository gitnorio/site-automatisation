  ...
  return (
    <div className="koto-marketing-page">
      ...
      <section className="koto-pricing-row koto-page-shell">
        <div className="koto-pricing-row__media"><Image src="/images/product/koto-discovery-platform-light.webp" alt="Vue interne Koto présentant la progression d’une consultation" fill sizes="(max-width: 760px) 100vw, 50vw" /></div>
