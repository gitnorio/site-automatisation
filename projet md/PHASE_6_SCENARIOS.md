...
| Budget incompatible | décision commerciale déterministe | maximum sous 2 500 $ CA → `unqualified` |
...
3. dossier complet avec budget maximal sous 2 500 $ CA → `unqualified`;
...
Le seuil de 2 500 $ CA est une hypothèse pilote, pas une vérité universelle. La phase 7 doit déterminer s’il faut le modifier ou le rendre configurable par agence.
