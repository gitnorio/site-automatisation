...
export default function MethodologyPage() {
  return <div className="page-shell page-stack">
    <RetroWindow title="Notre méthodologie — Processus en 7 étapes" headingLevel="h1" controls><div className="hero-grid"><div><h2 className="section-heading">Avancer par étapes vérifiables.</h2><p className="section-lede">Chaque mandat commence par le processus réel de l’entreprise. Nous définissons ce qui doit être automatisé, ce qui doit rester sous contrôle humain et comment mesurer la réussite.</p></div><div className="editorial-image"><Image src="/images/editorial/methodology-table.webp" alt="Cartographie détaillée d’un processus sur une table de travail" width={1200} height={900} /></div></div></RetroWindow>
